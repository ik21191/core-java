...
public class BuilderPatterDemo {
  ...
  public static void main(String[] args) {
    ...
    BankAccount bankAccount1 = BankAccount.builder(100L).build();

    System.out.println(bankAccount1);

    // Creating account with Account Number and Owner
    BankAccount bankAccount2 = BankAccount.builder(1001).owner("Imran").build();

    System.out.println(bankAccount2);

    // Creating account with Account Number, Owner and branch
    BankAccount bankAccount3 = BankAccount.builder(1001).owner("Imran").branch("Delhi").build();

    System.out.println(bankAccount3);

    // Creating account with Account Number, Owner, branch and balance
    BankAccount bankAccount4 =
        BankAccount.builder(1001).owner("Imran").branch("Delhi").balance(1000.12).build();

    System.out.println(bankAccount4);

    // Creating account with Account Number, Owner, branch, balance and interest rate
    BankAccount bankAccount5 = BankAccount.builder(1001).owner("Imran").branch("Delhi")
        .balance(1000.12).interestRate(2.6).build();
...
class BankAccount {
  ...
  public String toString() {
    return "accountNumber: " + accountNumber + ", owner: " + owner + ", branch: " + branch
