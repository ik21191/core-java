...
public class FindAllSubString {
	...
	public static void main(String[] args) {
		...
		while((startIndex = sourceString.indexOf(subString)) != -1) {
			...
			System.out.println("Sub String: " + sourceString.substring(startIndex, startIndex + subString.length()));
			/**Example using substring(int startIndex, int endIndex)*/
			//sourceString = sourceString.substring(startIndex + subString.length(), sourceString.length());
